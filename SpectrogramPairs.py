# Generates the Spectrogram Pairs
import pandas as pd
import numpy as np
...
#Read the iEEG data and convert it to a Data Frame.
...
def main():
    ...
    # Creates a list of the paths of the Data File.
    pairs = []
    start = 1; stop = 5
    for i in range(start,stop):
        pairs.append(['/home/rohan/train_1/1_' + str(i) + '_0.mat','/home/rohan/train_1/1_' + str(i) + '_1.mat'])
